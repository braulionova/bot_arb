...
pub const RAMSES_V3_FACTORY: Address = address!("46A3A41bd932244Dd08186e4c19F1a7E0CBB00Df");
...
pub async fn index_priority_pools<P: Provider + Clone + 'static>(
    ...
    let all_pools: &[(Address, DexType, Address, Address, u32, &str)] = &[
        ...
        // ── ADDITIONAL CROSS-DEX POOLS FOR ARB EXPANSION ──

        // SushiSwapV3 — low competition, cross-DEX with UniV3
        (address!("49845e79e38e7b0e80d5d5e8d0e25c4e2d26e158"), DexType::SushiSwapV3, WETH, USDT, 5, "SushiV3 WETH/USDT 0.05%"),
        (address!("a8e8aca4ed87d2c15a254e04cd2e137e35780a34"), DexType::SushiSwapV3, WETH, ARB, 5, "SushiV3 WETH/ARB 0.05%"),
        (address!("3fc5e5e64e8bc0e18c170b43e2047a73dc710ea2"), DexType::SushiSwapV3, ARB, USDC, 5, "SushiV3 ARB/USDC 0.05%"),
        (address!("cda2062e638196e816b5ac02f1ac4e7e1b91c4f1"), DexType::SushiSwapV3, WETH, WBTC, 5, "SushiV3 WETH/WBTC 0.05%"),

        // PancakeSwapV3 — cross-DEX pairs (vs UniV3 and Camelot)
        (address!("389938CF14Be379217570D8e4619E51fBDafaa21"), DexType::PancakeSwapV3, WETH, ARB, 25, "PcsV3 WETH/ARB 0.25%"),
        (address!("5e3C3a063cc9C6b5F42c8a45e3eF9E3Aab7A1B29"), DexType::PancakeSwapV3, WETH, USDT, 1, "PcsV3 WETH/USDT 0.01%"),

        // CamelotV3 (Algebra) — HIGH MARGIN, low competition
        (address!("e7664229bbed4fbde66e507345e0e1fdd9987b6d"), DexType::CamelotV3, WETH, ARB, 5, "CamelotV3 WETH/ARB"),
        (address!("f5b3c461fb8e5d0f6eb6e37058d7739e6aad4490"), DexType::CamelotV3, WETH, USDT, 5, "CamelotV3 WETH/USDT"),
        (address!("1c2bbac0b204eeb3ffb888bb852aebaac5092558"), DexType::CamelotV3, ARB, USDC, 5, "CamelotV3 ARB/USDC"),
        (address!("6a8113e7f3d5b1c7e5c02508fc146d507e5af0a5"), DexType::CamelotV3, WETH, WBTC, 5, "CamelotV3 WETH/WBTC"),
        (address!("de81f0e07568c2d00f2c06fe16c3e5e0b50e2e33"), DexType::CamelotV3, WETH, GMX, 5, "CamelotV3 WETH/GMX"),
        (address!("f8a46777d2186de578263b5d0e91b7a6b9f7f3e0"), DexType::CamelotV3, WETH, LINK, 5, "CamelotV3 WETH/LINK"),
        (address!("a31e8051e2d654cf50ea4bfa14e34399d0f2b7f6"), DexType::CamelotV3, WETH, PENDLE, 5, "CamelotV3 WETH/PENDLE"),

        // CamelotV2 — more pairs for triangular arbs
        (address!("8cBB25dAdC1E6F42017E43E4C03dFE05b3178979"), DexType::CamelotV2, WETH, RDNT, 30, "Camelot WETH/RDNT"),
        (address!("a1e4649fD8E713DB7189e2CfBf46244A4a9b5599"), DexType::CamelotV2, WETH, JONES, 30, "Camelot WETH/JONES"),
        (address!("49b75c0DDc24478A7FE1eB9436e4dd8a11B8d1b0"), DexType::CamelotV2, ARB, USDC, 30, "Camelot ARB/USDC"),
        (address!("e52DB521c5A38CfD5C2c57A0B6e0F4dF49CDEC87"), DexType::CamelotV2, WBTC, USDC, 30, "Camelot WBTC/USDC"),

        // SushiSwapV2 — more pairs
        (address!("83e42f1b10e30c7B62Fb10d62A50aE4b5e64fc43"), DexType::SushiSwapV2, WETH, ARB, 30, "Sushi WETH/ARB"),
        (address!("aee68A0Ab44bd50c4F34d186c43b8b5c5CF42698"), DexType::SushiSwapV2, WETH, GMX, 30, "Sushi WETH/GMX"),
        (address!("11A8144bDAce50F4E80E1421e2dCe27eE1a6Bd69"), DexType::SushiSwapV2, WETH, WBTC, 30, "Sushi WETH/WBTC"),

        // Stablecoin cross-DEX (high-frequency, consistent profit)
        (address!("a20430f7f6e0ba9dE12F62A11f6cCBC35B0f0279"), DexType::CamelotV2, USDC, USDT, 4, "Camelot USDC/USDT"),
        (address!("50e3b956058Cf4A3B2f8Be6dfc845C2d6e5BD225"), DexType::SushiSwapV2, USDC, USDT, 30, "Sushi USDC/USDT"),

        // weETH/WETH — LST arb (consistent spread vs wstETH/WETH)
        (address!("293dfd996d34e486a0e36e4fb94b94aa27d1a0e1"), DexType::UniswapV3, WEETH, WETH, 1, "UniV3 weETH/WETH 0.01%"),
        (address!("cba1a82c4c68dbfe42e1eb0aee76dec27c84abaf"), DexType::CamelotV3, WEETH, WETH, 1, "CamelotV3 weETH/WETH"),
...
pub async fn index_background<P: Provider + Clone + 'static>(
    ...
    let v2_factories = [
        // Aggressive indexing: more pools = more longtail arb opportunities
        (UNISWAP_V2_FACTORY, DexType::UniswapV2, "Uniswap V2", 3000u64),
        (CAMELOT_V2_FACTORY, DexType::CamelotV2, "Camelot V2", 2000),
        (SUSHISWAP_V2_FACTORY, DexType::SushiSwapV2, "SushiSwap V2", 1500),
        (RAMSES_V2_FACTORY, DexType::RamsesV2, "Ramses V2", 1000),
        (TRADERJOE_V1_FACTORY, DexType::UniswapV2, "TraderJoe V1", 500),
        (ZYBERSWAP_V2_FACTORY, DexType::UniswapV2, "Zyberswap V2", 300),
        (CHRONOS_V2_FACTORY, DexType::UniswapV2, "Chronos V2", 300),
    ];
    ...
    let v3_factories = [
        ...
        // Ramses V3 uses UniV3 interface (same getPool/PoolCreated events)
        (RAMSES_V3_FACTORY, DexType::UniswapV3, "Ramses V3"),
...
async fn read_camelot_fees<P: Provider + Clone>(
    ...
    match tokio::try_join!(b0.call(), b1.call()) {
        Ok((f0, f1)) => {
            // Camelot token0FeePercent() returns fee in 1/100 of percent
            // e.g. 300 = 0.3%, 150 = 0.15%
            // Convert to basis points: 300 / 10 = 30 bps
            let bps0 = ((f0 as u32) / 10).max(1);
            let bps1 = ((f1 as u32) / 10).max(1);
            let effective = bps0.max(bps1).max(1);
            (effective, Some(bps0), Some(bps1))
        }
